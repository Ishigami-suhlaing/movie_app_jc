...
private val newMovieData = listOf<NewMovieData>(
    NewMovieData("A fragrant Flower Blooms with Dignity", "Des1", R.drawable.a_fragrant_flower_bloms_with_dignity),
...
//                })
    ...
    if(isLoading.value){
        ...
        Column(
            ...
            PopularCard(popularMovies,     navController = navController
            )
